...
function AboutMePage() {
  ...
  const handleSubmit = (e) => {
    ...
    // Prepare data to be passed to the database
    const dataToSubmit = {
      ...formData,
    ...
    // You can replace the above line with an API call to your database
  };

  return (
    <div className='flex min-h-screen bg-gray-100 ml-32 mt-4'>
      <form className='p-8 w-full max-w-4xl' onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="relative mt-4 md:mt-0">
            ...
            <div className="w-full flex items-center border border-gray-300 bg-white rounded p-2 cursor-pointer">
              ...
              <button
                type="button"
                className="text-customgray900 ml-44 text-xl focus:outline-none"
        ...
        <div className="flex mt-14 space-x-3">
          <button type="submit" className="bg-customTeal text-white px-4 py-3 rounded-lg text-sm font-notosans gap-2 font-normal">Save Changes</button>
          <button type="button" className="border border-customTeal text-customTeal px-4 py-3 rounded-lg text-sm font-normal font-notosans gap-2">Cancel</button>
        </div>
      </form>
    </div>
  );
