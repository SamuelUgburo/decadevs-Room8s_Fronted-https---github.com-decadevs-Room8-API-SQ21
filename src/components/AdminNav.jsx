...
const AdminNav = ({notifications = 3, initials = "SC"}) => {
  return (
    <div className='pl-6 pr-11 pb-1 m-0 bg-white'>
    <div className="flex justify-around items-end">
        ...
        <div className="justify-center items-center gap-2 inline-flex">
            ...
            <div className="w-12 h-12 mb-2  bg-gray-200 rounded-full justify-center items-center inline-flex">
